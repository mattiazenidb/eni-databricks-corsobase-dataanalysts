...
df_sensor_bronze = spark.read.table(f'{catalog}.{schema}.sensor_bronze')
...
df_sensor_bronze_intermediate = spark.read.table(f'{catalog}.{schema}.sensor_bronze_intermediate')
...
df_sensor_hourly = spark.read.table(f'{catalog}.{schema}.sensor_hourly')
df_turbine = spark.read.table(f'{catalog}.{schema}.turbine')
df_historical_turbine_status = spark.read.table(f'{catalog}.{schema}.historical_turbine_status')
